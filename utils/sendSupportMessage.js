...
async function sendSupportMessage(leadName, recipientEmail) {
  ...
  let mailOptions = {
    ...
    html: `<p>Hi ${leadName},</p><p>Thank you for writing to us! We wholeheartedly appreciate your interest in Apparium. Expect a reply from us within the next 48 hours.</p><p>Stay growth hungry,</p><p>Team Apparium</p>`, // HTML body
  };
